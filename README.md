...
Data Engineer based in Dublin, currently an **Investment Data Specialist at Utmost Group**, building data pipelines and AI-assisted tooling. Looking at Data Engineer, AI Infrastructure Engineer, and data-powered backend roles across Dublin Big Tech, Irish tech, and quant trading firms.

### 📌 Highlights

- ⚡ Cut a batch pipeline's execution time by **52%** (25 → 12 minutes)
- 🚀 Optimised a query on a **375M-row table** from 3–5 minutes down to **9 seconds** (95%+ improvement)
- 📊 Pipelines processing **500K+ records** per cycle
- ☁️ AWS Certified Solutions Architect – Associate (Aug 2026)
